...
require (
	...
	github.com/paysuper/paysuper-proto/go/billingpb v0.0.0-20200512110458-4926400e07b9
	...
	github.com/paysuper/paysuper-proto/go/reporterpb v0.0.0-20200424194932-ce37bf63cef9
