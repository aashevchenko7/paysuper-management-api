...
func (s *BillingServerOkTemporaryMock) GetActsOfCompletionList(ctx context.Context, in *billingpb.ActsOfCompletionListRequest, opts ...client.CallOption) (*billingpb.ActsOfCompletionListResponse, error) {
	panic("implement me")
}
...
func (s *BillingServerOkTemporaryMock) GetSubscriptionOrders(ctx context.Context, in *billingpb.GetSubscriptionOrdersRequest, opts ...client.CallOption) (*billingpb.GetSubscriptionOrdersResponse, error) {
	panic("implement me")
}
...
func (s *BillingServerOkTemporaryMock) FindSubscriptions(ctx context.Context, in *billingpb.FindSubscriptionsRequest, opts ...client.CallOption) (*billingpb.FindSubscriptionsResponse, error) {
	panic("implement me")
}

func (s *BillingServerOkTemporaryMock) DeleteCustomerCard(ctx context.Context, in *billingpb.DeleteCustomerCardRequest, opts ...client.CallOption) (*billingpb.EmptyResponseWithStatus, error) {
	panic("implement me")
}
...
func (s *BillingServerOkTemporaryMock) ListMerchantsForAgreement(
	ctx context.Context,
	in *billingpb.MerchantListingRequest,
	opts ...client.CallOption,
...
func (s *BillingServerOkTemporaryMock) DeserializeCookie(ctx context.Context, in *billingpb.DeserializeCookieRequest, opts ...client.CallOption) (*billingpb.DeserializeCookieResponse, error) {
	panic("implement me")
}
