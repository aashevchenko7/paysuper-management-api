...
func (s *BillingServerSystemErrorMock) GetActsOfCompletionList(ctx context.Context, in *billingpb.ActsOfCompletionListRequest, opts ...client.CallOption) (*billingpb.ActsOfCompletionListResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) DeleteRecurringSubscription(ctx context.Context, in *billingpb.DeleteRecurringSubscriptionRequest, opts ...client.CallOption) (*billingpb.EmptyResponseWithStatus, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) GetCustomerShortInfo(ctx context.Context, in *billingpb.GetCustomerShortInfoRequest, opts ...client.CallOption) (*billingpb.GetCustomerShortInfoResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) GetSubscription(ctx context.Context, in *billingpb.GetSubscriptionRequest, opts ...client.CallOption) (*billingpb.GetSubscriptionResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) GetSubscriptionOrders(ctx context.Context, in *billingpb.GetSubscriptionOrdersRequest, opts ...client.CallOption) (*billingpb.GetSubscriptionOrdersResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) FindSubscriptions(ctx context.Context, in *billingpb.FindSubscriptionsRequest, opts ...client.CallOption) (*billingpb.FindSubscriptionsResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) DeleteCustomerCard(ctx context.Context, in *billingpb.DeleteCustomerCardRequest, opts ...client.CallOption) (*billingpb.EmptyResponseWithStatus, error) {
	panic("implement me")
}
...
func (s *BillingServerSystemErrorMock) ListMerchantsForAgreement(
	ctx context.Context,
	in *billingpb.MerchantListingRequest,
	opts ...client.CallOption,
...
func (s *BillingServerSystemErrorMock) SetMerchantAcceptedStatus(ctx context.Context, in *billingpb.SetMerchantAcceptedStatusRequest, opts ...client.CallOption) (*billingpb.SetMerchantAcceptedStatusResponse, error) {
	panic("implement me")
}
...
func (s *BillingServerSystemErrorMock) GetAdminByUserId(ctx context.Context, in *billingpb.CommonUserProfileRequest, opts ...client.CallOption) (*billingpb.UserRoleResponse, error) {
	panic("implement me")
}

func (s *BillingServerSystemErrorMock) RoyaltyReportFinanceDone(ctx context.Context, in *billingpb.ReportFinanceDoneRequest, opts ...client.CallOption) (*billingpb.EmptyResponseWithStatus, error) {
	panic("implement me")
}
