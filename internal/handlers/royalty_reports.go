...
// @success 200 {object} grpc.RoyaltyReportsPaginate Returns the royalty reports list
...
// @accept application/json
// @produce application/json
// @success 200 {object} grpc.RoyaltyReport Returns the royalty report
// @failure 400 {object} grpc.ResponseErrorMessage Invalid request data
...
// @accept application/json
// @produce application/json
// @success 200 {object} grpc.TransactionsPaginate Returns the transactions list
// @failure 400 {object} grpc.ResponseErrorMessage Invalid request data
// @failure 404 {object} grpc.ResponseErrorMessage Not found
// @failure 500 {object} grpc.ResponseErrorMessage Internal Server Error
// @param report_id path {string} true The unique identifier for the royalty report.
...
// @accept application/json
// @produce application/json
// @body grpc.MerchantReviewRoyaltyReportRequest
...
// @accept application/json
// @produce application/json
// @body grpc.ChangeRoyaltyReportRequest
