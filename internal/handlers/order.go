...
/*func (h *OrderRoute) formatOrder(in interface{}) {
	moneyTotalPaymentAmount := tools.New()
	moneyGrossRevenue := tools.New()
	moneyTaxFee := tools.New()
	moneyTaxFeeCurrencyExchangeFee := tools.New()
	moneyTaxFeeTotal := tools.New()
	moneyMethodFeeTotal := tools.New()
	moneyMethodFeeTariff := tools.New()
	moneyMethodFixedFeeTariff := tools.New()
	moneyPaysuperFixedFee := tools.New()
	moneyFeesTotal := tools.New()
	moneyFeesTotalLocal := tools.New()
	moneyNetRevenue := tools.New()
	moneyRefundGrossRevenue := tools.New()
	moneyMethodRefundFeeTariff := tools.New()
	moneyMerchantRefundFixedFeeTariff := tools.New()
	moneyRefundTaxFee := tools.New()
	moneyRefundTaxFeeCurrencyExchangeFee := tools.New()
	moneyPaysuperRefundTaxFeeCurrencyExchangeFee := tools.New()
	moneyRefundReverseRevenue := tools.New()
	moneyRefundFeesTotal := tools.New()
	moneyRefundFeesTotalLocal := tools.New()
	moneyOrderCharge := tools.New()

	if _, ok := in.(*billingpb.OrderViewPrivate); ok {
		moneyTotalPaymentAmount := tools.New()
		moneyPaymentGrossRevenueLocal := tools.New()
		moneyPaymentGrossRevenueOrigin := tools.New()
		moneyPaymentGrossRevenue := tools.New()
		moneyPaymentTaxFee := tools.New()
		moneyPaymentTaxFeeLocal := tools.New()
		moneyPaymentTaxFeeOrigin := tools.New()
		moneyPaymentTaxFeeCurrencyExchangeFee := tools.New()
		moneyPaymentTaxFeeTotal := tools.New()
		moneyPaymentGrossRevenueFx := tools.New()
		moneyPaymentGrossRevenueFxTaxFee := tools.New()
		moneyPaymentGrossRevenueFxProfit := tools.New()
		moneyGrossRevenue := tools.New()
		moneyTaxFee := tools.New()
		moneyTaxFeeCurrencyExchangeFee := tools.New()
		moneyTaxFeeTotal := tools.New()
		moneyMethodFeeTotal := tools.New()
		moneyMethodFeeTariff := tools.New()
		moneyPaysuperMethodFeeTariffSelfCost := tools.New()
		moneyPaysuperMethodFeeProfit := tools.New()
		moneyMethodFixedFeeTariff := tools.New()
		moneyPaysuperMethodFixedFeeTariffFxProfit := tools.New()
		moneyPaysuperMethodFixedFeeTariffSelfCost := tools.New()
		moneyPaysuperMethodFixedFeeTariffTotalProfit := tools.New()
		moneyPaysuperFixedFee := tools.New()
		moneyPaysuperFixedFeeFxProfit := tools.New()
		moneyFeesTotal := tools.New()
		moneyFeesTotalLocal := tools.New()
		moneyNetRevenue := tools.New()
		moneyPaysuperMethodTotalProfit := tools.New()
		moneyPaysuperTotalProfit := tools.New()
		moneyPaymentRefundGrossRevenueLocal := tools.New()
		moneyPaymentRefundGrossRevenueOrigin := tools.New()
		moneyPaymentRefundGrossRevenue := tools.New()
		moneyPaymentRefundTaxFee := tools.New()
		moneyPaymentRefundTaxFeeLocal := tools.New()
		moneyPaymentRefundTaxFeeOrigin := tools.New()
		moneyPaymentRefundFeeTariff := tools.New()
		moneyMethodRefundFixedFeeTariff := tools.New()
		moneyRefundGrossRevenue := tools.New()
		moneyRefundGrossRevenueFx := tools.New()
		moneyMethodRefundFeeTariff := tools.New()
		moneyPaysuperMethodRefundFeeTariffProfit := tools.New()
		moneyPaysuperMethodRefundFixedFeeTariffSelfCost := tools.New()
		moneyMerchantRefundFixedFeeTariff := tools.New()
		moneyPaysuperMethodRefundFixedFeeTariffProfit := tools.New()
		moneyRefundTaxFee := tools.New()
		moneyRefundTaxFeeCurrencyExchangeFee := tools.New()
		moneyPaysuperRefundTaxFeeCurrencyExchangeFee := tools.New()
		moneyRefundTaxFeeTotal := tools.New()
		moneyRefundReverseRevenue := tools.New()
		moneyRefundFeesTotal := tools.New()
		moneyRefundFeesTotalLocal := tools.New()
		moneyPaysuperRefundTotalProfit := tools.New()
		moneyOrderCharge := tools.New()
		moneyOrderChargeBeforeVat := tools.New()
		moneyTaxRate := tools.New()
	}
}*/
